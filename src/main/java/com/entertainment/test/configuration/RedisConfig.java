...
//    }
    ...
    public RedisTemplate<String, Object> redisTemplate(RedisConnectionFactory redisConnectionFactory) {
        ...
        // 建议使用这种方式，小范围指定白名单
        ParserConfig.getGlobalInstance().addAccept("com.entertainment.test.entity.");
        ParserConfig.getGlobalInstance().addAccept("com.entertainment.test.controller.");
//        ParserConfig.getGlobalInstance().addAccept("so.change.api.domain.json.");
